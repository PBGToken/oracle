...
let pendingMessages: {method: "get" | "set", key: string, value?: any, resolve: ResolveCallback, reject: RejectCallback}[] = []
...
function fetchInternal(controller: ServiceWorker, method: string, key: string, value: any | undefined, resolve: ResolveCallback, reject: RejectCallback) {
...
export function fetchWorker(method: "get", key: "deviceId" | "events" | "isAuthorized" | "isSubscribed" | "notificationsGranted" | "privateKey" | "status"): Promise<any>;
export function fetchWorker(method: "set", key: "deviceId" | "privateKey", value: any): Promise<any>;
export function fetchWorker(method: "get" | "set", key: "deviceId" | "events" | "isAuthorized" | "isSubscribed" | "notificationsGranted" | "privateKey" | "status", value?: any): Promise<any> {
